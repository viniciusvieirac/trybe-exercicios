...
const noEmergencyTasksHeaders2 = document.querySelector('.no-emergency-tasks')
noEmergencyTasksHeaders2.style.backgroundColor = 'rgb(249, 219, 94)';
...
footContainer.style.backgroundColor = 'rgb(0, 53, 51)';
